...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** The columns, geonetry type and other info relating to the shapes
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** A chart with shape length, area and its name.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of Maryland with segmented zipcodes
...
**Task** Run the following code. Describe the output in the space below. **Answer** "To enable caching of data, set `options(tigris_use_cache = TRUE)`
...
**Task** Run the following code. Describe the output in the space below. **Answer** Lots of information, essentially lots of municipalities with location and other informaation.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A chart with the same info as above, but just for Maryland counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of Maryland by county, but the Chesapeake Bay makes it look a bit weird.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A combination of the Maryland zip code and county maps.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A chart with the number of foreclouseres per zip code in March 2023.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Joins foreclosure data with the zip code shape info.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of Maryland based on how many foreclosures are occuring in specfic zip codes.
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer** "To install your API key for use in future sessions, run this function with `install = TRUE`."
...
library(janitor)
library(tidycensus)
census_api_key("5e1e484648848b2f18092c874cfee08e142e6aeb")
```
...
**Task** Run the following code. Describe the output in the space below. **Answer** It condenses the notice data set and adds a similarly simple table for Maryland population by county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** We get more census data with the geometry of the counties in the same dataset.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Notices to foreclose by county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** County polygon and poulation information
...
**Task** Run the following code. Describe the output in the space below. **Answer** Combination of foreclosure data w/ county pop/polygon data
...
**Task** Run the following code. Describe the output in the space below. **Answer** Rate of forclosures by county
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map based on the rate of foreclosures by county
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map based on the rate of foreclosures by county with a different color theme
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** A map based on the rate of foreclosures by county with a different color theme with a log scale
