...
```{r echo=FALSE}
census_api_key("5e1e484648848b2f18092c874cfee08e142e6aeb", install=TRUE)
```
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Median household income by Maryland county
...
Is the difference between Calvert and Montgomery significant? **Answer** No, because their margin of error overlaps.

Is the difference between Howard and everyone else significant? **Answer** Yes, because even with it and other counties' margin of error, Howard County has the largest median household income.
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** There are 50 zip codes in which at least 60% of kids go to college, the median household income of those zip codes is $111,448. There are 76 zip codes in which less than 40% of kids go to college, the median household income of those zip codes is $69,252.
...
**Task** What is another question you could ask of this data? **Answer** What is the average amount and lean of political donations based on household income of zip codes.
