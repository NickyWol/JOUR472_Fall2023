...
**A1:** It's a link to a website rather than a file.
...
**A2:** There are 9,776 different records (rows) in this dataset. You can mainly gather the location, time and severity from the data.
...
**A3:** The deepest earthquake is 669.982 and its magnitude is 4.20.
...
**A4:** There are 12 earthquakes that were a magnitude of greater than 6. 
...
**A5:** There are five earthquakes in the data set that have a magnitude larger than 6 and a depth of less than 20.
...
**A6:** There 7,413 earthquakes that either have a magnitude larger than 6 or a depth of less than 20.
...
**A8:** Earthquake is the most common tremor in the data set, followed by quarry blast.
...
**A9:** The average depth of an earthquake is 25.28 in this data set. These finding were surprising because a lot of them were very shallow in general, and the two human-made types (explosion, quarry blast) were above ground, which makes sense after thinking about it.
...
**A12**: Hour 2 had the most amount of serious earthquakes (69) while hour 12 had the least amount of serious earthqaukes (33).
