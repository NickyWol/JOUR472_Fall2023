...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** 3,822 rows and 4 columns
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer** Mutate adds the month column and changes the label. Group by groups the total_calls by month, and summarize adds them together so they can be organized. Then arrange sorts the total_calls from greatest to least.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a blank gray box.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a bar graph with a month label in chronological order on the x-axis and a count column on the y-axis. The graph is all in gray.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The x-axis is now sorted from least to greatest count.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The x-axis and y-axis have swapped places, so the months are on the y-axis and count is on the x-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background color of the graph is now white.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** There is a theme, with the background color and font changing.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is a title and descriptive axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A table with the total calls groubed by individual date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There is a line graph tracking the total calls across each date between February 2022 and February 2023.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It looks like each individual week is labelled, and they're all overlapping.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The dates are diagonal so they are somewhat visible.
