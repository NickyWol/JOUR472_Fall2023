...
**Answer 60,712 observations and eight variables**
...
In the space below, write the name of the title from the first row of the "title" column. **Answer Directed Research**
...
**Answer Call the data set and then sort by the term column and then summarize info by counting the number of rows.**
...
**Answer It's sorting out by the count of individual terms.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer It's sorting the total number of seats by individual terms.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer It is similar to the last codeblock, but there is an additional column with the mean number of seats by each term.**
...
**Answer The seats are split up by department with the other columns of data applicable to each specific department. It is sorted by the total number of class seats per department.**
...
1.  How has the mean number of seats per class in each department changed over time?

2.  How has the total number of seats changed from term to term? Has it increased, decreased or mostly stayed the same over time?

3.  Which apartment currently has the most total seats and largest mean class size?
