...
**A1.** The top 10 results include common words relating to court trial, including client, respondent, trsust ,attorney, etc. The other notable words relate to common actions and the description of them in the complaints, including conduct for the former and failing, the top response, for the latter.
...
**A2.** The top answer is "attorney trust account", which was 5.79% of all trigrams collected.
