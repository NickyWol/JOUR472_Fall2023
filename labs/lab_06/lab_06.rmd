...
baltimore_911_with_demos <- baltimore_911 |> left_join(maryland_zcta, join_by(zip_code == zcta5n))
```
...
A2. Cecil County had the most calls in August, which was much more than its second-highest. August was also the highest month of calls for the other two respective counties. 314 GROVE NECK RD EARLEVILLE, MD in Cecil County has the most calls with 15, which makes sense because it is a drug and addiction rehab center.
